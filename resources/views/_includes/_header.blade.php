...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets/dist/css/dataTables.min.css')}}">
    <link rel="stylesheet" href="{{asset('assets/dist/css/datatables_css_jquery.dataTables.min.css')}}">
